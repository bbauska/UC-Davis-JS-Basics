...
# 2.01 Module 2 Introduction (0:51)
...
# 2.02 Visual Studio -- Part 1 (4:39)
...
save this as &quot;<b>myfile.hml</b>&quot;. I&apos;m going to save an HTML file, to
begin with on my desktop. Once I have an HTML file, then I can get the
basic HTML structure by holding down &quot;<b>Shift</b>&quot;, pressing an
<b>exclamation point</b>, and then pressing &quot;<b>Tab</b>&quot; and that will give
me the basic structure for my page.

If you take an HTML class, you&apos;ll learn to type the <b>doctype</b> and to
...
# 2.03 Visual Studio -- Part 2 (5:48)
...
# 2.04 Visual Studio -- Part 3 (9:48)
...
Extensions. Here are Extensions here. &lbrack;inaudible&rbrack; Settings. You can do
...
I&apos;ve got the Color Themes and I can select that, &lbrack;inaudible&rbrack;.
...
# 2.05 Operators, Booleans & Selection in JavaScript (8:11) 
...
statement is false. And up here we&apos;ll do console log &lbrack;SOUND&rbrack; The
...
&lbrack;inaudible&rbrack; into a problem because I misspelled that. I misspell
...
var gotDinner = false. If(gotBreakfast &vert;&vert; gotLunch &vert;&vert; gotDinner), if
...
assign it foods &lbrack; i &rbrack;. That&apos;s going to get that first food, whatever
...
an array, and we could say NodeA.childNodes&lbrack;0&rbrack; would be Node-A1. So on
...
to take each paragraph, so I&apos;m going to say ps &lbrack;i&rbrack;.style.color equals
...
and then I could do myClass&lbrack;i&rbrack;. First-time to the loop, that&apos;s going
...
the page to add this class, I could give it an ID and use &lbrack;inaudible&rbrack;.
...
&lbrack;MUSIC&rbrack; Next, we&apos;ll take a look at one of
...
I&apos;m going to say myDiv.children&lbrack;1&rbrack;. What that&apos;s going to do is it&apos;s
...
and &lbrack;INAUDIBLE&rbrack; use my tickmarks and put in here The window, width is,
...
will just copy this console.log here &lbrack;INAUDIBLE&rbrack; type it all again and
...
comments over here about how wide and how &lbrack;INAUDIBLE&rbrack;, window height
...
&lbrack;MUSIC&rbrack; So a variable here, get rid of this Is making variable are
...
the tick marks &lbrack;inaudible&rbrack; can pass any variables in here. I can just
...
actually do it the other way around. And it have var &lbrack;COUGH&rbrack; where
...
kilometers, the &lbrack;COUGH&rbrack; the ratio is this and to convert. K to M, the
...
here. And that&apos;s great. Now we can do an &lbrack;inaudible&rbrack; for details
...
&lbrack;MUSIC&rbrack; The next step in this process is to actually write the
...
test. Let&apos;s try it again. Now, let&apos;s do Fenway Park &lbrack;inaudible&rbrack;
